...
LIBS          = $(SUBLIBS) -F/opt/homebrew/lib -framework QtGui -framework AppKit -framework ImageIO -framework Metal -framework QtCore -framework IOKit -framework DiskArbitration -framework AGL -framework OpenGL   
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		ProgettoPAO2025.pro media/AbstractMedia.h media/AbstractMedia.cpp
...
distdir: FORCE
	...
	$(COPY_FILE) --parents media/AbstractMedia.h $(DISTDIR)/
	$(COPY_FILE) --parents media/AbstractMedia.cpp $(DISTDIR)/
...
AbstractMedia.o: media/AbstractMedia.cpp media/AbstractMedia.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o AbstractMedia.o media/AbstractMedia.cpp
