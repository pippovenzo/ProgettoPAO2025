#############################################################################
# Makefile for building: BibliotecaVirtuale.app/Contents/MacOS/BibliotecaVirtuale
# Generated by qmake (3.1) (Qt 6.9.0)
# Project:  BibliotecaVirtuale.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile BibliotecaVirtuale.pro
#############################################################################
...
DEFINES       = -DPROJECT_DIR=\"/Users/pippovenzo/Documents/PAO/BibliotecaVirtuale\" -DQT_NO_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_CORE_LIB
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = BibliotecaVirtuale1.0.0
DISTDIR = /Users/pippovenzo/Documents/PAO/BibliotecaVirtuale/.tmp/BibliotecaVirtuale1.0.0
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		BibliotecaVirtuale.pro src/Media/AbstractMedia.h \
		src/Media/Album.h \
		src/Media/Article.h \
		src/Media/Book.h \
...
QMAKE_TARGET  = BibliotecaVirtuale
DESTDIR       = 
TARGET        = BibliotecaVirtuale.app/Contents/MacOS/BibliotecaVirtuale

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 15.5
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Library/Developer/CommandLineTools
EXPORT__QMAKE_STASH_ = /Users/pippovenzo/Documents/PAO/BibliotecaVirtuale/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/pippovenzo/Documents/PAO/BibliotecaVirtuale/BibliotecaVirtuale.pro
...
BibliotecaVirtuale.app/Contents/MacOS/BibliotecaVirtuale:  $(OBJECTS)  
	@test -d BibliotecaVirtuale.app/Contents/MacOS/ || mkdir -p BibliotecaVirtuale.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: BibliotecaVirtuale.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile BibliotecaVirtuale.pro
...
BibliotecaVirtuale.app/Contents/PkgInfo: 
	@test -d BibliotecaVirtuale.app/Contents || mkdir -p BibliotecaVirtuale.app/Contents
	@$(DEL_FILE) BibliotecaVirtuale.app/Contents/PkgInfo
	@echo "APPL????" > BibliotecaVirtuale.app/Contents/PkgInfo
BibliotecaVirtuale.app/Contents/Info.plist: 
	@test -d BibliotecaVirtuale.app/Contents || mkdir -p BibliotecaVirtuale.app/Contents
	@$(DEL_FILE) BibliotecaVirtuale.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.BibliotecaVirtuale,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.BibliotecaVirtuale,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,BibliotecaVirtuale,g" -e "s,@LIBRARY@,BibliotecaVirtuale,g" -e "s,\$${EXECUTABLE_NAME},BibliotecaVirtuale,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >BibliotecaVirtuale.app/Contents/Info.plist

all: Makefile \
		BibliotecaVirtuale.app/Contents/PkgInfo \
		BibliotecaVirtuale.app/Contents/Info.plist BibliotecaVirtuale.app/Contents/MacOS/BibliotecaVirtuale
...
distclean: clean 
	-$(DEL_FILE) -r BibliotecaVirtuale.app
...
moc_CardView.cpp: src/View/CardView.h \
	...
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/pippovenzo/Documents/PAO/BibliotecaVirtuale/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/pippovenzo/Documents/PAO/BibliotecaVirtuale -I/Users/pippovenzo/Documents/PAO/BibliotecaVirtuale -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/17/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib src/View/CardView.h -o moc_CardView.cpp
